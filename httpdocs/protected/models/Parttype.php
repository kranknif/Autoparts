...
/**
 * This is the model class for table "parttype".
 *
 * The followings are the available columns in table 'parttype':
...
class Parttype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('parttype_id, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'autoparts' => array(self::HAS_MANY, 'Autopart', 'parttype_id'),
		);
	}
